    ...
    return (
        <div>
            ...
            <div className="hero bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <button onClick={pop} className="btn bg-[#3FCDA6] text-white">Reade More <FaArrowRight></FaArrowRight> </button>
            ...
            <div className="flex items-center justify-center my-10">
                <button onClick={pop} className="btn bg-[#3FCDA6] text-white">See All Articles</button>
            </div>
